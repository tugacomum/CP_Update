...
import { StyleSheet, ImageBackground, Image, View, ScrollView, RefreshControl } from 'react-native';
import {
    Avatar,
    Title,
    Caption,
...
import Workout from '../../components/profileworkout';
...
export default function Profile({ navigation }) {
    ...
    const getWorkouts = async () => {
        try {
            const response = await api.get('workouthistoric').then(r => r.data);
